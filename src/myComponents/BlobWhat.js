...
const IMAGES = ['how01.png', 'how02.png', 'how03.png']
const SLOGANS = [['Stocking', 'Optimization'], ['Harvest', 'Optimization'], ['Harvest', 'Plant']]
...
export default class BlobWhat extends Component {
  ...
  draw = p5 => {
    p5.updatePixels()
    drawBubbles(p5)
    //document.getElementsByClassName("scroll")[0].style.transform = "none"
  }
  ...
  render() {
    ...
    <div style={{ height: '80vh' }}>
      ...
      <Sketch preload={this.preload} setup={this.setup} draw={this.draw} mouseWheel={throttle(this.nextSlide, 2200)} style={{  }}	 />
    </div>
    )
  }
}
